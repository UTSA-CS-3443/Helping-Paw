...
public class OptionsController implements EventHandler<MouseEvent>, Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		Image phil = new Image(this.getClass().getResourceAsStream("/images/phil.jpeg"));
		imgPhil.setImage(phil);
		Image ed = new Image(this.getClass().getResourceAsStream("/images/ed.jpeg"));
		imgEd.setImage(ed);
		Image salem = new Image(this.getClass().getResourceAsStream("/images/salem.jpeg"));
		imgSalem.setImage(salem);
